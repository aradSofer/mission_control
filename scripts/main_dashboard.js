...
function displayTasks() {
  ...
  if (allTasks) {
    for (let x in allTasks) {
      ...
      cell.html("");
      cell.html(
        cell.html() + ` <span class="badge ${badgeColor}" id="task-${task.taskId}">${title}</span>`
      );
    }
  }
    ...
    document.querySelectorAll(".badge").forEach((element) => {
        element.addEventListener("click", function (event) {
            ...
            if (task) {
                ...
                $("#dynamic-popup .modal-title").text("Edit Task").attr("data-task-id", task.taskId);
                        ...
                        case "medium":
                            ...
                            if (modalHeader == "Edit Task") {
                                ...
                                if (task) {
                                    ...
                                    task.assignee = allUsers.find(u => u.email == taskAssigneeInput.val()).userId;
